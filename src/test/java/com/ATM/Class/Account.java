...
public class Account {
	// creating private variables which will not directly accessed by other classes
	...
	// different types of constructors with parameters
	public Account() {
	}
...
// 	declaring setters and getter method to enable the private data for the objects
